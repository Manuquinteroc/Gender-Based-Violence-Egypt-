---
title: "Appendix B: Can Media Campaigns Empower Women Facing Gender-Based Violence amid COVID-19? All Treatments indicators Separate. Violence against Women in the Time of COVID-19 (Facebook and WhatsApp Indicators pooled)."
author: ""
date: "6/6/2021"
geometry: margin=1in
...
cov_var <- c("Facebook, \\\\ WhatsApp Ind., and\\\\ WhatsApp Group", "TV Show Reminder")
...
age <- lm(age ~ pooledF_WIG + reminder_10018 + factor(block_ids),
          weights = weight, data = merged)

ba <- lm(ba_above ~ pooledF_WIG + reminder_10018 + factor(block_ids),
         weights = weight, data = merged)

male_c <- lm(male_children ~ pooledF_WIG + reminder_10018 + factor(block_ids),
             weights = weight, data = merged)

female_c <- lm(female_children ~ pooledF_WIG + reminder_10018 + factor(block_ids),
               weights = weight, data = merged)

sum_fam_mem <- lm(sum_family_mem ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                  weights = weight, data = merged)
...
married <- lm(married ~ pooledF_WIG + reminder_10018 + factor(block_ids),
              weights = weight, data = merged)

h_age <- lm(husb_age ~ pooledF_WIG + reminder_10018 + factor(block_ids),
            weights = weight, data = merged)

educ_husb <- lm(education_husb_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                weights = weight, data = merged)

length_marriage <- lm(length_marriage ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                      weights = weight, data = merged)

husb_liv <- lm(husb_live_loc_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
               weights = weight, data = merged)
...
bcovid_act <- lm(bcovid_activity_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                 weights = weight, data = merged)

bcovid_ph <- lm(bcovid_activity_ph_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                weights = weight, data = merged)

bcovid_act_husb <- lm(bcovid_act_husbmar_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                      weights = weight, data = merged)



bcovid_ph_husb <- lm(bcovid_activity_husbmar_ph_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                     weights = weight, data = merged)

dcovid_act <- lm(dcovid_activity_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                 weights = weight, data = merged)


dcovid_ph <- lm(dcovid_activity_ph_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                weights = weight, data = merged)

dcovid_act_husb <- lm(dcovid_activity_husb_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                      weights = weight, data = merged)

dcovid_ph_husb <- lm(dcovid_activity_husbmar_ph_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                     weights = weight, data = merged)

covid_inc <- lm(covid_inc_decline ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                weights = weight, data = merged)
...
tv_morning <- lm(tv_morning_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                 weights = weight, data = merged)

tv_afternoon <- lm(tv_afternoon_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                   weights = weight, data = merged)

tv_evening <- lm(tv_evening_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                 weights = weight, data = merged)

tv_sattelite <- lm(tv_sattelite_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                   weights = weight, data = merged)

tv_top3_chan <- lm(tv_top3_chan_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                   weights = weight, data = merged)

tv_top3_shows <- lm(tv_top3_shows_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                    weights = weight, data = merged)

sat_show <- lm(sat_show_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
               weights = weight, data = merged)
...
hours <- lm(hours_soc_med_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
            weights = weight, data = merged)

whats <- lm(socmed_whatsapp ~ pooledF_WIG + reminder_10018 + factor(block_ids),
            weights = weight, data = merged)

fb <- lm(socmed_Facebook ~ pooledF_WIG + reminder_10018 + factor(block_ids),
         weights = weight, data = merged)

instagram <- lm(socmed_Instagram ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                weights = weight, data = merged)

youtube <- lm(socmed_YouTube ~ pooledF_WIG + reminder_10018 + factor(block_ids),
              weights = weight, data = merged)

twitter <- lm(socmed_Twitter ~ pooledF_WIG + reminder_10018 + factor(block_ids),
              weights = weight, data = merged)

snapchat <- lm(socmed_Snapchat ~ pooledF_WIG + reminder_10018 + factor(block_ids),
               weights = weight, data = merged)

telegram <- lm(socmed_Telegram ~ pooledF_WIG + reminder_10018 + factor(block_ids),
               weights = weight, data = merged)

socmed_dv <- lm(merged$'X2mos_socmed_dv_num' ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                weights = weight, data = merged)

whatsapp_dv <- lm(merged$'X2mos_whatsapp_dv_num' ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                  weights = weight, data = merged)
...
husb_final_say <- lm(husb_final_say_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                     weights = weight, data = merged)

husb_provide_inc <- lm(husb_provide_inc_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                       weights = weight, data = merged)

husb_justified_yell <- lm(husb_justified_yell_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                          weights = weight, data = merged)

husb_justified_beat<- lm(husb_justified_beat_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                         weights = weight, data = merged)

prioritize_educ <- lm(prioritize_educ_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                      weights = weight, data = merged)

future_equal_say <- lm(future_equal_say_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                       weights = weight, data = merged)

future_equal_rights <- lm(future_equal_rights_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                          weights = weight, data = merged)
...
bc_yell <- lm(bc19_yell_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
              weights = weight, data = merged)


bc_hit <- lm(bc19_hit_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
             weights = weight, data = merged)

dc_yell <- lm(dc19_yell_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
              weights = weight, data = merged)

dc_hit <- lm(dc19_hit_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
             weights = weight, data = merged)
...
talk_husband <- lm(talk_husband_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                   weights = weight, data = merged)

talk_family <- lm(talk_family_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                  weights = weight, data = merged)

report_authorities <- lm(report_authorities_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                         weights = weight, data = merged)

look_online <- lm(look_online_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                  weights = weight, data = merged)

contact_org <- lm(contact_org_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                  weights = weight, data = merged)
...
known_online <- lm(know_online_valid_noaut_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                   weights = weight, data = merged)

known_online_nehad <- lm(know_online_nehad_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                         weights = weight, data = merged)

bc_look_online <- lm(bc19_look_online_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                     weights = weight, data = merged)

dc_look_online <- lm(dc19_look_online_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                     weights = weight, data = merged)

know_org <- lm(know_org_noaut_valid_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
               weights = weight, data = merged)

know_org_nehad <- lm(know_org_nehad_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                     weights = weight, data = merged)

bc_look_org<- lm(bc19_look_org_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                 weights = weight, data = merged)

dc_look_org <- lm(dc19_look_org_num ~ pooledF_WIG + reminder_10018 + factor(block_ids),
                  weights = weight, data = merged)
...
```{r include=FALSE}
dir.create(file.path("Tables/Appendix B"), showWarnings = FALSE)

```

\clearpage
```{r echo=FALSE, results="asis"}
cat( Panel_Balance(Table1A,Table1B, 6),"\n", file = 'Tables/Appendix B/Table1.tex')
cat( Panel_Balance(Table1A,Table1B, 6) )
```

```{r echo=FALSE, results="asis"}

cat(alignTable(Table2, 0.5), "\n", file = 'Tables/Appendix B/Table2.tex')
cat(alignTable(Table2, 0.5))
```

```{r echo=FALSE, results="asis"}

cat(alignTable(Table3, 0.5), "\n", file = 'Tables/Appendix B/Table3.tex')
cat(alignTable(Table3, 0.5))
```

```{r echo=FALSE, results="asis"}

cat(alignTable(Table4, 2), "\n", file = 'Tables/Appendix B/Table4.tex')
cat(alignTable(Table4, 2))
```

```{r echo=FALSE, results="asis"}

cat( Table5,"\n", file = 'Tables/Appendix B/Table5.tex')
cat( Table5 )
```

```{r echo=FALSE, results="asis"}
cat( Table6,"\n", file = 'Tables/Appendix B/Table6.tex')
cat( Table6 )
```

```{r echo=FALSE, results="asis"}
cat( Table7,"\n", file = 'Tables/Appendix B/Table7.tex')
cat( Table7 )
```

```{r echo=FALSE, results="asis"}
cat(alignTable(Table8, 1.5), "\n", file = 'Tables/Appendix B/Table8.tex')
cat(alignTable(Table8, 1.5))
```
...
covariates <- c("Facebook, \\\\ WhatsApp Ind., and\\\\ WhatsApp Group", "TV Show Reminder")
...
# Missing 3: saturday and the last two
tv_0_2 <-lm(zscore ~ pooledF_WIG  + reminder_10018 +
              tv_evening_num + tv_sattelite_num + tv_top3_chan_num + tv_top3_shows_num + sat_show_num +
              factor(block_ids),
            weights = weight,
            data = merged)

tv_1_2 <-lm(tv_evening_num_end ~ pooledF_WIG  + reminder_10018 +
              tv_evening_num + tv_sattelite_num + tv_top3_chan_num + tv_top3_shows_num + sat_show_num +
              factor(block_ids),
            weights = weight,
            data = merged)
...
tv_2_2 <-lm(three_viewed_channel_end_num ~ pooledF_WIG + reminder_10018 +
              tv_evening_num + tv_sattelite_num + tv_top3_chan_num + tv_top3_shows_num + sat_show_num +
              factor(block_ids),
            weights = weight,
            data = merged)

tv_3_2 <-lm(three_viewed_shows_end_num ~ pooledF_WIG+ reminder_10018 +
              tv_evening_num + tv_sattelite_num + tv_top3_chan_num + tv_top3_shows_num + sat_show_num +
              factor(block_ids),
            weights = weight,
            data = merged)

tv_4_2 <-lm(tv_sat_2mos_end_num ~ pooledF_WIG+ reminder_10018 +
              tv_evening_num + tv_sattelite_num + tv_top3_chan_num + tv_top3_shows_num + sat_show_num +
              factor(block_ids),
            weights = weight,
            data = merged)

tv_5_2 <-lm(watch_hekayat_end_num ~ pooledF_WIG+ reminder_10018 +
              tv_evening_num + tv_sattelite_num + tv_top3_chan_num + tv_top3_shows_num + sat_show_num +
              factor(block_ids),
            weights = weight,
            data = merged)

tv_6_2 <-lm(heard_hekayat_end_num ~ pooledF_WIG +reminder_10018 +
              tv_evening_num + tv_sattelite_num + tv_top3_chan_num + tv_top3_shows_num + sat_show_num +
              factor(block_ids),
            weights = weight,
            data = merged)

tv_7_2 <-lm(how_heard_hekayat_num ~ pooledF_WIG +reminder_10018 +
              tv_evening_num + tv_sattelite_num + tv_top3_chan_num + tv_top3_shows_num + sat_show_num +
              factor(block_ids),
            weights = weight,
            data = merged)

tv_8_2 <-lm(whatsapp_remind_2mos_end_num ~ pooledF_WIG +reminder_10018 +
              tv_evening_num + tv_sattelite_num + tv_top3_chan_num + tv_top3_shows_num + sat_show_num +
              factor(block_ids),
            weights = weight,
            data = merged)

tv_9_2 <-lm(wheter_episodes_hekayat_end_num ~ pooledF_WIG + reminder_10018 +
              tv_evening_num + tv_sattelite_num + tv_top3_chan_num + tv_top3_shows_num + sat_show_num +
              factor(block_ids),
            weights = weight,
            data = merged)
...
tv_10_2 <-lm(episodes_hekayat_end_num ~ pooledF_WIG + reminder_10018 +
               tv_evening_num + tv_sattelite_num + tv_top3_chan_num + tv_top3_shows_num + sat_show_num +
               factor(block_ids),
             weights = weight,
             data = merged)
...
tv_11_2 <-lm(episodes_content_end_num_vague ~ pooledF_WIG  + reminder_10018 +
               tv_evening_num + tv_sattelite_num + tv_top3_chan_num + tv_top3_shows_num + sat_show_num +
               factor(block_ids),
             weights = weight,
             data = merged)
...
tv_12_2 <-lm(episode_content_like_end_num_vague ~ pooledF_WIG  + reminder_10018 +
               tv_evening_num + tv_sattelite_num + tv_top3_chan_num + tv_top3_shows_num + sat_show_num +
               factor(block_ids),
             weights = weight,
             data = merged)
...
l0 <- linearHypothesis(tv_0_2, "pooledF_WIG = reminder_10018", digits = 3)
l1 <- linearHypothesis(tv_1_2, "pooledF_WIG = reminder_10018", digits = 3)
l2 <- linearHypothesis(tv_2_2, "pooledF_WIG = reminder_10018", digits = 3)
l3 <- linearHypothesis(tv_3_2, "pooledF_WIG = reminder_10018", digits = 3)
l4 <- linearHypothesis(tv_4_2, "pooledF_WIG = reminder_10018", digits = 3)
l5 <- linearHypothesis(tv_5_2, "pooledF_WIG = reminder_10018", digits = 3)
l6 <- linearHypothesis(tv_6_2, "pooledF_WIG = reminder_10018", digits = 3)
l7 <- linearHypothesis(tv_7_2, "pooledF_WIG = reminder_10018", digits = 3)
l8 <- linearHypothesis(tv_8_2, "pooledF_WIG = reminder_10018", digits = 3)
l9 <- linearHypothesis(tv_9_2, "pooledF_WIG = reminder_10018", digits = 3)
l10 <- linearHypothesis(tv_10_2, "pooledF_WIG = reminder_10018", digits = 3)
l11 <- linearHypothesis(tv_11_2, "pooledF_WIG = reminder_10018", digits = 3)
l12 <- linearHypothesis(tv_12_2, "pooledF_WIG = reminder_10018", digits = 3)



pvals1 <- c(round(l0$`Pr(>F)`[2], digits = 4), round(l1$`Pr(>F)`[2], digits = 4), round(l2$`Pr(>F)`[2], digits = 4),
            round(l3$`Pr(>F)`[2], digits = 4), round(l4$`Pr(>F)`[2], digits = 4), round(l5$`Pr(>F)`[2], digits = 4),
            round(l6$`Pr(>F)`[2], digits = 4), round(l7$`Pr(>F)`[2], digits = 4), round(l8$`Pr(>F)`[2], digits = 4),
            round(l9$`Pr(>F)`[2], digits = 4), round(l10$`Pr(>F)`[2], digits = 4), round(l11$`Pr(>F)`[2], digits = 4),
            round(l12$`Pr(>F)`[2], digits = 4))
...
Table9A <- stargazer(tv_0_2, tv_1_2, tv_2_2, tv_3_2, tv_4_2, tv_5_2,
                     ...
                     omit = omit_var,
                     omit.stat=c("f", "ser","adj.rsq"),
                     add.lines = list(c("F, WI, WG = TV (p-value)", pvals1)),
                     column.sep.width = "0pt",
...
Table9B <- stargazer(tv_0_2, tv_1_2, tv_2_2, tv_3_2, tv_4_2, tv_5_2,
                        ...
                        omit = omit_var,
                        omit.stat=c("f", "ser","adj.rsq"),
                        add.lines = list(c("Control Mean", 0, TV_control_mean), c("F, WI, WG = TV (p-value)", pvals1)),
                        column.sep.width = "0pt",
                        title = "Treatment effect on TV show consumption",
                        type = "latex")
...
lm_0_2 <-lm(zscore ~ pooledF_WIG  + reminder_10018 +
              X2mos_socmed_dv_num + X2mos_whatsapp_dv_num + factor(block_ids),
            weights = weight,
            data = merged)

lm_1_2 <-lm(videos_socmed_2mos_end_num ~ pooledF_WIG  + reminder_10018 +
              X2mos_socmed_dv_num + X2mos_whatsapp_dv_num + factor(block_ids),
            weights = weight,
            data = merged)

lm_2_2 <-lm(videos_whatsapp_2mos_end_num ~ pooledF_WIG  + reminder_10018 +
              X2mos_socmed_dv_num + X2mos_whatsapp_dv_num + factor(block_ids),
            weights = weight,
            data = merged)

lm_3_2 <-lm(videos_whatsapp_receive_end_num ~ pooledF_WIG  + reminder_10018 +
              X2mos_socmed_dv_num + X2mos_whatsapp_dv_num + factor(block_ids),
            weights = weight,
            data = merged)

lm_4_2 <-lm(videos_watched_end_num ~ pooledF_WIG  + reminder_10018 +
              X2mos_socmed_dv_num + X2mos_whatsapp_dv_num + factor(block_ids),
            weights = weight,
            data = merged)

lm_5_2 <-lm(videos_watched_no_end_num ~ pooledF_WIG  + reminder_10018 +
              X2mos_socmed_dv_num + X2mos_whatsapp_dv_num + factor(block_ids),
            weights = weight,
            data = merged)

lm_6_2 <-lm(videos_watched_content_end_num_vague ~ pooledF_WIG  + reminder_10018 +
              X2mos_socmed_dv_num + X2mos_whatsapp_dv_num + factor(block_ids),
            weights = weight,
            data = merged)

lm_7_2 <-lm(video_content_like_end_num_vague ~ pooledF_WIG  + reminder_10018 +
              X2mos_socmed_dv_num + X2mos_whatsapp_dv_num + factor(block_ids),
            weights = weight,
            data = merged)

l0 <- linearHypothesis(lm_0_2, "pooledF_WIG = reminder_10018", digits = 3)
l1 <- linearHypothesis(lm_1_2, "pooledF_WIG = reminder_10018", digits = 3)
l2 <- linearHypothesis(lm_2_2, "pooledF_WIG = reminder_10018", digits = 3)
l3 <- linearHypothesis(lm_3_2, "pooledF_WIG = reminder_10018", digits = 3)
l4 <- linearHypothesis(lm_4_2, "pooledF_WIG = reminder_10018", digits = 3)
l5 <- linearHypothesis(lm_5_2, "pooledF_WIG = reminder_10018", digits = 3)
l6 <- linearHypothesis(lm_6_2, "pooledF_WIG = reminder_10018", digits = 3)
l7 <- linearHypothesis(lm_7_2, "pooledF_WIG = reminder_10018", digits = 3)


pvals1 <- c(round(l0$`Pr(>F)`[2], digits = 4), round(l1$`Pr(>F)`[2], digits = 4), round(l2$`Pr(>F)`[2], digits = 4), round(l3$`Pr(>F)`[2], digits = 4),
            round(l4$`Pr(>F)`[2], digits = 4), round(l5$`Pr(>F)`[2], digits = 4), round(l6$`Pr(>F)`[2], digits = 4), round(l7$`Pr(>F)`[2], digits = 4))
...
Table10B <- stargazer(lm_0_2, lm_1_2, lm_2_2, lm_3_2, lm_4_2, lm_5_2, lm_6_2, lm_7_2,
                        ...
                        add.lines = list(c("Control Mean", 0, FS_fw_control_mean), c("F, WI, WG = TV (p-value)", pvals1)),
...
```{r echo=FALSE, results="asis"}
cat( Panel(Table9A,Table9B, 14,2),"\n", file = 'Tables/Appendix B/Table9.tex')
cat( Panel(Table9A,Table9B, 14,2) )
...
\clearpage
```{r echo=FALSE, results="asis"}
cat( Panel(Table10A,Table10B, 9,1),"\n", file = 'Tables/Appendix B/Table10.tex')
cat( Panel(Table10A,Table10B, 9,1) )
...
```{r include=FALSE}
controls <- c("Facebook, \\\\ WhatsApp Ind., and\\\\ WhatsApp Group", "TV Show Reminder")
...
# All Controls
know_1 <-lm(zscore ~ pooledF_WIG  + reminder_10018 + 
...
know_2 <-lm(online_dvsa_noaut_end_num ~ pooledF_WIG  + reminder_10018 + 
              know_online_valid_noaut_num + bc19_look_online_num + dc19_look_online_num + bc19_look_org_num + dc19_look_org_num +
              know_org_noaut_valid_num + know_online_nehad_num + know_org_nehad_num +
              factor(block_ids), 
            weights = weight, 
...
know_3 <-lm(online_dvsa_nehad_end_num ~ pooledF_WIG  + reminder_10018 + 
              know_online_valid_noaut_num + bc19_look_online_num + dc19_look_online_num + bc19_look_org_num + dc19_look_org_num +
              know_org_noaut_valid_num +  know_online_nehad_num + know_org_nehad_num +
              factor(block_ids), 
            weights = weight, 
...
know_4 <-lm(org_dvsa_noaut_end_num ~ pooledF_WIG  + reminder_10018 + 
              know_online_valid_noaut_num + bc19_look_online_num + dc19_look_online_num + bc19_look_org_num + dc19_look_org_num +
              know_org_noaut_valid_num +  know_online_nehad_num + know_org_nehad_num +
              factor(block_ids), 
            weights = weight, 
...
know_5 <-lm(org_dvsa_nehad_end_num ~ pooledF_WIG  + reminder_10018 + 
              know_online_valid_noaut_num + bc19_look_online_num + dc19_look_online_num + bc19_look_org_num + dc19_look_org_num +
              know_org_noaut_valid_num +  know_online_nehad_num + know_org_nehad_num +
              factor(block_ids), 
            weights = weight, 
...
l0 <- linearHypothesis(know_1, "pooledF_WIG = reminder_10018", digits = 3)
l1 <- linearHypothesis(know_2, "pooledF_WIG = reminder_10018", digits = 3)
l2 <- linearHypothesis(know_3, "pooledF_WIG = reminder_10018", digits = 3)
l3 <- linearHypothesis(know_4, "pooledF_WIG = reminder_10018", digits = 3)
l4 <- linearHypothesis(know_5, "pooledF_WIG = reminder_10018", digits = 3)


pvals1 <- c(round(l0$`Pr(>F)`[2], digits = 4), round(l1$`Pr(>F)`[2], digits = 4), round(l2$`Pr(>F)`[2], digits = 4),
            round(l3$`Pr(>F)`[2], digits = 4), round(l4$`Pr(>F)`[2], digits = 4))
...
Table11B <- stargazer(know_1, know_2, know_3, know_4, know_5,
                          ...
                          omit = omit_var, 
                          omit.stat=c("f", "ser","adj.rsq"), 
                          add.lines = list(c("Control Mean", 0, know2_mean), c("F, WI, WG = TV (p-value)", pvals1)),
                          column.sep.width = "0pt",
                          title = "Treatment effect on knowledge about treatment information",
                          type = "latex")
...
domestic_z <- lm(zscore ~ pooledF_WIG +reminder_10018 + 
...
domestic_1 <- lm(husb_final_say_end_num ~ pooledF_WIG +reminder_10018 + 
                   husb_final_say_num + prioritize_educ_num + husb_provide_inc_num + husb_justified_yell_num + 
                   husb_justified_beat_num + future_equal_say_num + future_equal_rights_num +
                   factor(block_ids),
                 weights = weight, data = merged)
...
domestic_2 <- lm(husb_inc_end_num ~ pooledF_WIG +reminder_10018 + 
                   husb_final_say_num + prioritize_educ_num + husb_provide_inc_num + husb_justified_yell_num + 
                   husb_justified_beat_num + future_equal_say_num + future_equal_rights_num +
                   factor(block_ids),
                 weights = weight, data = merged)
...
domestic_3 <- lm(husb_just_yell_end_num ~ pooledF_WIG +reminder_10018 + 
                   husb_final_say_num + prioritize_educ_num + husb_provide_inc_num + husb_justified_yell_num + 
                   husb_justified_beat_num + future_equal_say_num + future_equal_rights_num +
                   factor(block_ids),
                 weights = weight, data = merged)

domestic_4 <- lm(woman_work_outside_end_num ~ pooledF_WIG +reminder_10018 + 
                   husb_final_say_num + prioritize_educ_num + husb_provide_inc_num + husb_justified_yell_num + 
                   husb_justified_beat_num + future_equal_say_num + future_equal_rights_num +
                   factor(block_ids),
                 weights = weight, data = merged)

domestic_5 <- lm(female_circ_marriage_end_num ~ pooledF_WIG +reminder_10018 + 
                   husb_final_say_num + prioritize_educ_num + husb_provide_inc_num + husb_justified_yell_num + 
                   husb_justified_beat_num + future_equal_say_num + future_equal_rights_num +
                   factor(block_ids),
                 weights = weight, na.action = na.omit, data = merged)

domestic_6 <- lm(circ_tf_end_num ~ pooledF_WIG +reminder_10018 + 
                   husb_final_say_num + prioritize_educ_num + husb_provide_inc_num + husb_justified_yell_num + 
                   husb_justified_beat_num + future_equal_say_num + future_equal_rights_num +
                   factor(block_ids),
                 weights = weight, data = merged)

domestic_7 <- lm(marriage_age_tf_end_num ~ pooledF_WIG +reminder_10018 + 
                   husb_final_say_num + prioritize_educ_num + husb_provide_inc_num + husb_justified_yell_num + 
                   husb_justified_beat_num + future_equal_say_num + future_equal_rights_num +
                   factor(block_ids),
                 weights = weight,  data = merged)

domestic_8 <- lm(khul_divorce_tf_end_num ~ pooledF_WIG +reminder_10018 + 
                   husb_final_say_num + prioritize_educ_num + husb_provide_inc_num + husb_justified_yell_num + 
                   husb_justified_beat_num + future_equal_say_num + future_equal_rights_num +
                   factor(block_ids), 
                 weights = weight,  data = merged)
...
l1 <- linearHypothesis(domestic_z, "pooledF_WIG = reminder_10018", digits = 3)
l2 <- linearHypothesis(domestic_1, "pooledF_WIG = reminder_10018", digits = 3)
l3 <- linearHypothesis(domestic_2, "pooledF_WIG = reminder_10018", digits = 3)
l4 <- linearHypothesis(domestic_3, "pooledF_WIG = reminder_10018", digits = 3)
l5 <- linearHypothesis(domestic_4, "pooledF_WIG = reminder_10018", digits = 3)
l6 <- linearHypothesis(domestic_5, "pooledF_WIG = reminder_10018", digits = 3)
l7 <- linearHypothesis(domestic_6, "pooledF_WIG = reminder_10018", digits = 3)
l8 <- linearHypothesis(domestic_7, "pooledF_WIG = reminder_10018", digits = 3)
l9 <- linearHypothesis(domestic_8, "pooledF_WIG = reminder_10018", digits = 3)

pvals1 <- c(round(l1$`Pr(>F)`[2], digits = 4), round(l2$`Pr(>F)`[2], digits = 4), round(l3$`Pr(>F)`[2], digits = 4),
            round(l4$`Pr(>F)`[2], digits = 4), round(l5$`Pr(>F)`[2], digits = 4), round(l6$`Pr(>F)`[2], digits = 4),
            round(l7$`Pr(>F)`[2], digits = 4), round(l8$`Pr(>F)`[2], digits = 4), round(l9$`Pr(>F)`[2], digits = 4))
...
Table12B <- stargazer(domestic_z, domestic_1, domestic_2, domestic_3, domestic_4,
                           ...
                           omit = omit_var, 
                           omit.stat=c("f", "ser","adj.rsq"), 
                           add.lines = list(c("Control Mean", 0, husb_work_att_mean), c("F, WI, WG = TV (p-value)", pvals1)),
                           column.sep.width = "2pt",
                           title = "Treatment effects on attitudes towards gender and marital equality",
                           type = "latex")
...
att2_0 <- lm(zscore ~ pooledF_WIG +reminder_10018 + 
               husb_final_say_num + prioritize_educ_num + husb_provide_inc_num + husb_justified_yell_num + 
               husb_justified_beat_num + future_equal_say_num + future_equal_rights_num +
               factor(block_ids),
             weights = weight, na.action = na.omit, data = merged)

att2_1 <- lm(colleague_comment_looks_end_num ~ pooledF_WIG +reminder_10018 + 
               husb_final_say_num + prioritize_educ_num + husb_provide_inc_num + husb_justified_yell_num + 
               husb_justified_beat_num + future_equal_say_num + future_equal_rights_num +
               factor(block_ids),
             weights = weight, na.action = na.omit, data = merged)

att2_2 <- lm(verbal_harassment_legal_end_num ~ pooledF_WIG +reminder_10018 + 
               husb_final_say_num + prioritize_educ_num + husb_provide_inc_num + husb_justified_yell_num + 
               husb_justified_beat_num + future_equal_say_num + future_equal_rights_num +
               factor(block_ids),
             weights = weight,  data = merged)

att2_3 <- lm(intervene_work_harass_end_num ~ pooledF_WIG +reminder_10018 + 
               husb_final_say_num + prioritize_educ_num + husb_provide_inc_num + husb_justified_yell_num + 
               husb_justified_beat_num + future_equal_say_num + future_equal_rights_num +
               factor(block_ids),
             weights = weight, na.action = na.omit, data = merged)

att2_4 <- lm(women_clothes_harass_end_num ~ pooledF_WIG +reminder_10018 + 
               husb_final_say_num + prioritize_educ_num + husb_provide_inc_num + husb_justified_yell_num + 
               husb_justified_beat_num + future_equal_say_num + future_equal_rights_num +
               factor(block_ids),
             weights = weight, na.action = na.omit, data = merged)

att2_5 <- lm(intervene_hitting_street_num ~ pooledF_WIG +reminder_10018 + 
               husb_final_say_num + prioritize_educ_num + husb_provide_inc_num + husb_justified_yell_num + 
               husb_justified_beat_num + future_equal_say_num + future_equal_rights_num +
               factor(block_ids),
             weights = weight, na.action = na.omit, data = merged)

att2_6 <- lm(you_intervene_harass_end_num ~ pooledF_WIG +reminder_10018 + 
               husb_final_say_num + prioritize_educ_num + husb_provide_inc_num + husb_justified_yell_num + 
               husb_justified_beat_num + future_equal_say_num + future_equal_rights_num +
               factor(block_ids),
             weights = weight, na.action = na.omit, data = merged)

att2_7 <- lm(parents_assault_auth_end_num ~ pooledF_WIG +reminder_10018 + 
               husb_final_say_num + prioritize_educ_num + husb_provide_inc_num + husb_justified_yell_num + 
               husb_justified_beat_num + future_equal_say_num + future_equal_rights_num +
               factor(block_ids),
             weights = weight, na.action = na.omit, data = merged)

att2_8 <- lm(child_relative_assault_end_num ~ pooledF_WIG +reminder_10018 + 
               husb_final_say_num + prioritize_educ_num + husb_provide_inc_num + husb_justified_yell_num + 
               husb_justified_beat_num + future_equal_say_num + future_equal_rights_num +
               factor(block_ids),
             weights = weight, na.action = na.omit, data = merged)
...
l0 <- linearHypothesis(att2_0, "pooledF_WIG = reminder_10018", digits = 3)
l1 <- linearHypothesis(att2_1, "pooledF_WIG = reminder_10018", digits = 3)
l2 <- linearHypothesis(att2_2, "pooledF_WIG = reminder_10018", digits = 3)
l3 <- linearHypothesis(att2_3, "pooledF_WIG = reminder_10018", digits = 3)
l4 <- linearHypothesis(att2_4, "pooledF_WIG = reminder_10018", digits = 3)
l5 <- linearHypothesis(att2_5, "pooledF_WIG = reminder_10018", digits = 3)
l6 <- linearHypothesis(att2_6, "pooledF_WIG = reminder_10018", digits = 3)
l7 <- linearHypothesis(att2_7, "pooledF_WIG = reminder_10018", digits = 3)
l8 <- linearHypothesis(att2_8, "pooledF_WIG = reminder_10018", digits = 3)
...
Table13B <- stargazer(att2_0, att2_1, att2_2, att2_3, att2_4, att2_5, att2_6, att2_7, att2_8,
                      float.env = "sidewaystable",
                       ...
                       omit = c("Constant","block_ids"), 
                       omit.stat=c("f", "ser","adj.rsq"), 
                       add.lines = list(c("Control Mean", 0, att2_mean), c("F, WI, WG = TV (p-value)", pvals1)),
                       column.sep.width = "0pt",
                       title = "Treatment effect on attitudes on sexual violence",
                       type = "latex")
...
don_0 <-lm(zscore ~ pooledF_WIG  + reminder_10018 + 
             factor(block_ids), 
           weights = weight, 
           data = merged)


don_1 <-lm(donation__end_cont ~ pooledF_WIG  + reminder_10018 + 
             factor(block_ids), 
           weights = weight, 
           data = merged)

don_2 <-lm(donation_end_num ~ pooledF_WIG  + reminder_10018 + 
             factor(block_ids), 
           weights = weight, 
           data = merged)


l1 <- linearHypothesis(don_0, "pooledF_WIG = reminder_10018", digits = 3)
l2 <- linearHypothesis(don_1, "pooledF_WIG = reminder_10018", digits = 3)
l3 <- linearHypothesis(don_2, "pooledF_WIG = reminder_10018", digits = 3)
...
Table14 <- stargazer(don_0, don_1, don_2, 
                         ...
                         omit = c("Constant","block_ids"), 
                         omit.stat=c("f", "ser","adj.rsq"), 
                         add.lines = list(c("Control Mean", 0, donation_mean), c("F, WI, WG = TV (p-value)", pvals1)),
...
d_zscore <-lm(zscore ~ pooledF_WIG +reminder_10018 + 
...
dc_yell <- lm(dcovid_yelled_end_num ~ pooledF_WIG +reminder_10018 + 
                bc19_yell_num + dc19_yell_num + bc19_hit_num + dc19_hit_num + dcovid_yelled_end_num_refuse +
                factor(block_ids),
              weights = weight, data = merged)

dc_hit <- lm(dcovid_hit_end_num ~ pooledF_WIG +reminder_10018 +
               bc19_yell_num + dc19_yell_num + bc19_hit_num + dc19_hit_num + dcovid_hit_end_num_refuse +
               factor(block_ids),
             weights = weight, data = merged)

dc_assa <- lm(dcovid_assault_end_num ~ pooledF_WIG +reminder_10018 + 
...
l1 <- linearHypothesis(d_zscore, "pooledF_WIG = reminder_10018", digits = 3)
l2 <- linearHypothesis(dc_yell, "pooledF_WIG = reminder_10018", digits = 3)
l3 <- linearHypothesis(dc_hit, "pooledF_WIG = reminder_10018", digits = 3)
l4 <- linearHypothesis(dc_assa, "pooledF_WIG = reminder_10018", digits = 3)


pvals1 <- c(round(l1$`Pr(>F)`[2], digits = 4), round(l2$`Pr(>F)`[2], digits = 4), round(l3$`Pr(>F)`[2], digits = 4),
            round(l4$`Pr(>F)`[2], digits = 4))
...
d_zscore <-lm(zscore ~ pooledF_WIG +reminder_10018 + dcovid_yelled_end_num_refuse +
                dcovid_hit_end_num_refuse + dcovid_assault_end_num_refuse + 
                factor(block_ids),
              weights = weight, data = merged)
...
Table15B <- stargazer(d_zscore, dc_yell, dc_hit, dc_assa,
                             ...
                             omit = omit_var, 
                             omit.stat=c("f", "ser","adj.rsq"), 
                             add.lines = list(c("Control Mean", 0, rep_during_control), c("F, WI, WG = TV (p-value)", pvals1)),
                             column.sep.width = "5pt",
                             title = "Treatment effect on domestic and sexual violence experienced during COVID-19",
                             type = "latex",
                             out = "Table15B")
...
hyp_0 <-lm(zscore ~ pooledF_WIG  + reminder_10018 + 
             talk_husband_num + talk_family_num + report_authorities_num + look_online_num + contact_org_num +
             factor(block_ids), 
           weights = weight, 
           data = merged)

hyp_1 <-lm(dv_onlineres_end_num ~ pooledF_WIG  + reminder_10018 + 
             talk_husband_num + talk_family_num + report_authorities_num + look_online_num + contact_org_num +
             factor(block_ids), 
           weights = weight, 
           data = merged)

hyp_2 <-lm(dv_contactorg_end_num ~ pooledF_WIG  + reminder_10018 + 
             talk_husband_num + talk_family_num + report_authorities_num + look_online_num + contact_org_num +
             factor(block_ids), 
           weights = weight, 
           data = merged)

l1 <- linearHypothesis(hyp_0, "pooledF_WIG = reminder_10018", digits = 3)
l2 <- linearHypothesis(hyp_1, "pooledF_WIG = reminder_10018", digits = 3)
l3 <- linearHypothesis(hyp_2, "pooledF_WIG = reminder_10018", digits = 3)
...
hyp_1 <-lm(zscore ~ pooledF_WIG  + reminder_10018 + 
             factor(block_ids), 
           weights = weight, 
           data = merged)

hyp_2 <-lm(dv_onlineres_end_num ~ pooledF_WIG  + reminder_10018 + 
             look_online_num +
             factor(block_ids), 
           weights = weight, 
           data = merged)

hyp_3 <-lm(dv_contactorg_end_num ~ pooledF_WIG  + reminder_10018 + 
             contact_org_num +
             factor(block_ids), 
           weights = weight, 
           data = merged)

l1 <- linearHypothesis(hyp_1, "pooledF_WIG = reminder_10018", digits = 3)
l2 <- linearHypothesis(hyp_2, "pooledF_WIG = reminder_10018", digits = 3)
l3 <- linearHypothesis(hyp_3, "pooledF_WIG = reminder_10018", digits = 3)
...
Table16B <- stargazer(hyp_1, hyp_2, hyp_3,
                  ...
                  omit = omit_var, 
                  omit.stat=c("f", "ser","adj.rsq"), 
                  add.lines = list(c("Control Mean", 0, hyp_mean_1), c("F, WI, WG = TV (p-value)", pvals1)),
                  column.sep.width = "20pt",
                  title = "Treatment effect on hypothetical use of online resources and contact with an organization when responding to domestic violence",
                  type = "latex")
...
hyp_1 <-lm(sa_onlineres_end_num ~ pooledF_WIG  + reminder_10018 +
             talk_husband_num + talk_family_num + report_authorities_num + look_online_num + contact_org_num +
             factor(block_ids),
           weights = weight,
           data = merged)

hyp_2 <-lm(sa_contactorg_end_num ~ pooledF_WIG  + reminder_10018 +
             talk_husband_num + talk_family_num + report_authorities_num + look_online_num + contact_org_num +
             factor(block_ids),
           weights = weight,
           data = merged)
...
Table17B <- stargazer(hyp_0, hyp_1, hyp_2,
                     ...
                     omit = c("Constant", "block_ids"),
                     omit.stat=c("f", "ser","adj.rsq"),
                     add.lines = list(c("Control Mean", 0, hyp_mean_2), c("F, WI, WG = TV (p-value)", pvals1)),
                     column.sep.width = "10pt",
                     title = "Treatment effect on  hypothetical use of online resources and contact with an organization when responding to sexual violence",
                     type = "latex")
...
zs <-lm(during_zscore ~ pooledF_WIG  + reminder_10018 + 
          know_online_valid_noaut_num + bc19_look_online_num + dc19_look_online_num + bc19_look_org_num + dc19_look_org_num +
...
dc_accesson <-lm(dcovid_accessonline_end_num ~ pooledF_WIG  + reminder_10018 + 
                   know_online_valid_noaut_num + bc19_look_online_num + dc19_look_online_num + bc19_look_org_num + dc19_look_org_num +
...
dc_contactorg <-lm(dcovid_contactorg_end_num ~ pooledF_WIG  + reminder_10018 + 
                     know_online_valid_noaut_num + bc19_look_online_num + dc19_look_online_num + bc19_look_org_num + dc19_look_org_num +
...
l1 <- linearHypothesis(zs, "pooledF_WIG = reminder_10018", digits = 3)
l2 <- linearHypothesis(dc_accesson, "pooledF_WIG = reminder_10018", digits = 3)
l3 <- linearHypothesis(dc_contactorg, "pooledF_WIG = reminder_10018", digits = 3)
...
Table18B <- stargazer(zs, dc_accesson, dc_contactorg,
                            ...
                            omit = omit_var, 
                            omit.stat=c("f", "ser","adj.rsq"), 
                            add.lines = list(c("Control Mean", 0, know_during_mean), c("F, WI, WG = TV (p-value)", pvals1)),
                            column.sep.width = "25pt",
                            title = "Treatment effect on recent use of online resources and contact with an organization during COVID-19",
                            type = "latex")
...
fo_0 <- lm(zscore ~ pooledF_WIG +reminder_10018 + 
             husb_final_say_num + prioritize_educ_num + husb_provide_inc_num + husb_justified_yell_num + 
             husb_justified_beat_num + future_equal_say_num + future_equal_rights_num +
             factor(block_ids),
           weights = weight, data = merged)

fo_1 <- lm(future_equal_say_end_num ~ pooledF_WIG +reminder_10018 + 
             husb_final_say_num + prioritize_educ_num + husb_provide_inc_num + husb_justified_yell_num + 
             husb_justified_beat_num + future_equal_say_num + future_equal_rights_num +
             factor(block_ids),
           weights = weight, data = merged)
...
fo_2 <- lm(future_equal_rights_end_num ~ pooledF_WIG +reminder_10018 + 
             husb_final_say_num + prioritize_educ_num + husb_provide_inc_num + husb_justified_yell_num + 
             husb_justified_beat_num + future_equal_say_num + future_equal_rights_num +
             factor(block_ids),
           weights = weight,  data = merged)
...
l1 <- linearHypothesis(fo_0, "pooledF_WIG = reminder_10018", digits = 3)
l2 <- linearHypothesis(fo_1, "pooledF_WIG = reminder_10018", digits = 3)
l3 <- linearHypothesis(fo_2, "pooledF_WIG = reminder_10018", digits = 3)
...
Table19B <- stargazer(fo_0, fo_1, fo_2,
                      ...
                      omit = omit_var, 
                      omit.stat=c("f", "ser","adj.rsq"), 
                      add.lines = list(c("Control Mean", 0, fut_out_mean), c("F, WI, WG = TV (p-value)", pvals1)),
                      column.sep.width = "20pt",
                      title = "Treatment effect on views on women's future outlook toward gender and marital equality",
                      type = "latex")
...
hyp_1 <-lm(dv_talkhusb_end_num ~ pooledF_WIG  + reminder_10018 + 
             talk_husband_num + talk_family_num + report_authorities_num + look_online_num + contact_org_num +
             factor(block_ids), 
           weights = weight, 
           data = merged)

hyp_2 <-lm(dv_talktfam_end_num ~ pooledF_WIG  + reminder_10018 + 
             talk_husband_num + talk_family_num + report_authorities_num + look_online_num + contact_org_num +
             factor(block_ids), 
           weights = weight, 
           data = merged)

hyp_3 <-lm(dv_report_end_num ~ pooledF_WIG  + reminder_10018 + 
             talk_husband_num + talk_family_num + report_authorities_num + look_online_num + contact_org_num +
             factor(block_ids), 
           weights = weight, 
           data = merged)
...
l2 <- linearHypothesis(hyp_1, "pooledF_WIG = reminder_10018", digits = 3)
l3 <- linearHypothesis(hyp_2, "pooledF_WIG = reminder_10018", digits = 3)
l4 <- linearHypothesis(hyp_3, "pooledF_WIG = reminder_10018", digits = 3)
...
hyp_2 <-lm(dv_talkhusb_end_num ~ pooledF_WIG  + reminder_10018 + 
             talk_husband_num +
             factor(block_ids), 
           weights = weight, 
           data = merged)

hyp_3 <-lm(dv_talktfam_end_num ~ pooledF_WIG  + reminder_10018 + 
             talk_family_num +
             factor(block_ids), 
           weights = weight, 
           data = merged)

hyp_4 <-lm(dv_report_end_num ~ pooledF_WIG  + reminder_10018 + 
...
l2 <- linearHypothesis(hyp_2, "pooledF_WIG = reminder_10018", digits = 3)
l3 <- linearHypothesis(hyp_3, "pooledF_WIG = reminder_10018", digits = 3)
l4 <- linearHypothesis(hyp_4, "pooledF_WIG = reminder_10018", digits = 3)
...
hyp_1 <-lm(sa_talkfam_end_num ~ pooledF_WIG  + reminder_10018 +
             talk_husband_num + talk_family_num + report_authorities_num + look_online_num + contact_org_num +
             factor(block_ids),
           weights = weight,
           data = merged)

hyp_2 <-lm(sa_report_end_num ~ pooledF_WIG  + reminder_10018 +
             talk_husband_num + talk_family_num + report_authorities_num + look_online_num + contact_org_num +
             factor(block_ids),
           weights = weight,
           data = merged)
...
b_zscore <- lm(zscore ~ pooledF_WIG +reminder_10018 + 
                 bc19_yell_num + dc19_yell_num + bc19_hit_num + dc19_hit_num  +
                 bcovid_yelled_end_num_refuse + bcovid_hit_end_num_refuse + bcovid_assault_end_num_refuse + 
                 factor(block_ids),
               weights = weight, data = merged)

bc_yell <- lm(bcovid_yelled_end_num ~ pooledF_WIG +reminder_10018 + 
                bc19_yell_num + dc19_yell_num + bc19_hit_num + dc19_hit_num + bcovid_yelled_end_num_refuse +
                factor(block_ids),
              weights = weight, data = merged)

bc_hit <- lm(bcovid_hit_end_num ~ pooledF_WIG +reminder_10018 + 
               bc19_yell_num + dc19_yell_num + bc19_hit_num + dc19_hit_num + bcovid_hit_end_num_refuse +
               factor(block_ids),
             weights = weight, data = merged)
bc_assa <- lm(bcovid_assault_end_num ~ pooledF_WIG +reminder_10018 + 
                bc19_yell_num + dc19_yell_num + bc19_hit_num + dc19_hit_num + bcovid_assault_end_num_refuse +
                factor(block_ids),
              weights = weight, data = merged)


l1 <- linearHypothesis(b_zscore, "pooledF_WIG = reminder_10018", digits = 3)
l2 <- linearHypothesis(bc_yell, "pooledF_WIG = reminder_10018", digits = 3)
l3 <- linearHypothesis(bc_hit, "pooledF_WIG = reminder_10018", digits = 3)
l4 <- linearHypothesis(bc_assa, "pooledF_WIG = reminder_10018", digits = 3)
...
Table22B <- stargazer(b_zscore, bc_yell, bc_hit, bc_assa,
                           ...
                           omit = omit_var, 
                           omit.stat=c("f", "ser","adj.rsq"), 
                           add.lines = list(c("Control Mean", 0, rep_before_control), c("F, WI, WG = TV (p-value)", pvals1)),   
                           column.sep.width = "0pt",
                           title = "Treatment effects on domestic and sexual violence experienced before COVID-19",
                           type = "latex")


note.latex <- "\\multicolumn{5}{l} {\\parbox[t]{13.5cm}{ \\textit{Notes:} 
We report estimates from WGLS regressions where the weights are in the inverse probability of treatment 
assignment, including randomization block fixed effects. 
Regressions in Panel A include controls for all baseline covariates in the outcome family: 
Before COVID-19 heard of or experienced yelling, Before COVID-19 heard of or experienced hitting, 
...
# All family controls 
zs <-lm(zscore_bef ~ pooledF_WIG  + reminder_10018 + 
          know_online_valid_noaut_num + bc19_look_online_num + dc19_look_online_num + bc19_look_org_num + dc19_look_org_num +
...
bc_accesson <-lm(bcvovid_accessonline_end_num ~ pooledF_WIG  + reminder_10018 + 
                   know_online_valid_noaut_num + bc19_look_online_num + dc19_look_online_num + bc19_look_org_num + dc19_look_org_num +
...
bc_contactorg <-lm(bcovid_contactorg_end_num ~ pooledF_WIG  + reminder_10018 + 
                     know_online_valid_noaut_num + bc19_look_online_num + dc19_look_online_num + bc19_look_org_num + dc19_look_org_num +
...
l1 <- linearHypothesis(zs, "pooledF_WIG = reminder_10018", digits = 3)
l2 <- linearHypothesis(bc_accesson, "pooledF_WIG = reminder_10018", digits = 3)
l3 <- linearHypothesis(bc_contactorg, "pooledF_WIG = reminder_10018", digits = 3)
...
Table23B <- stargazer(zs, bc_accesson, bc_contactorg,
                            ...
                            omit = omit_var, 
                            omit.stat=c("f", "ser","adj.rsq"), 
                            add.lines = list(c("Control Mean", 0, know_mean), c("F, WI, WG = TV (p-value)", pvals1)),
                            column.sep.width = "25pt",
                            title = "Treatment effects on recent use of online resources and contact with an organization when responding to domestic and sexual violence before COVID-19",
                            type = "latex")
...
\clearpage
```{r echo=FALSE, results="asis"}
cat( Panel(Table11A,Table11B, 6),"\n", file = 'Tables/Appendix B/Table11.tex')
cat( Panel(Table11A,Table11B, 6) ) 
...
\clearpage
```{r echo=FALSE, results="asis"}
cat( Panel(Table12A,Table12B, 10, 1),"\n", file = 'Tables/Appendix B/Table12.tex')
cat( Panel(Table12A,Table12B, 10, 1))
...
\clearpage
```{r echo=FALSE, results="asis"}
cat( Panel(Table13A,Table13B, 10),"\n", file = 'Tables/Appendix B/Table13.tex')
cat( Panel(Table13A,Table13B, 10) )
```

\clearpage
```{r echo=FALSE, results="asis"}
cat(Table14, "\n", file = 'Tables/Appendix B/Table14.tex')
 cat( Table14 )
```
...
\clearpage
```{r echo=FALSE, results="asis"}
cat( Panel(Table15A,Table15B, 5),"\n", file = 'Tables/Appendix B/Table15.tex')
cat( Panel(Table15A,Table15B, 5) )
...
\clearpage
```{r echo=FALSE, results="asis"}
cat( Panel(Table16A,Table16B, 4),"\n", file = 'Tables/Appendix B/Table16.tex')
cat( Panel(Table16A,Table16B, 4) )
...
\clearpage
```{r echo=FALSE, results="asis"}
cat( Panel(Table17A,Table17B, 4),"\n", file = 'Tables/Appendix B/Table17.tex')
cat( Panel(Table17A,Table17B, 4) )
...
\clearpage
```{r echo=FALSE, results="asis"}
cat( Panel(Table18A,Table18B, 4),"\n", file = 'Tables/Appendix B/Table18.tex')
cat( Panel(Table18A,Table18B, 4) )
...
\clearpage
```{r echo=FALSE, results="asis"}
cat( Panel(Table19A,Table19B, 4),"\n", file = 'Tables/Appendix B/Table19.tex')
cat( Panel(Table19A,Table19B, 4) )
...
\clearpage
```{r echo=FALSE, results="asis"}
cat( Panel(Table20A,Table20B, 5),"\n", file = 'Tables/Appendix B/Table20.tex')
cat( Panel(Table20A,Table20B, 5) )
...
\clearpage
```{r echo=FALSE, results="asis"}
cat( Panel(Table21A,Table21B, 4),"\n", file = 'Tables/Appendix B/Table21.tex')
cat( Panel(Table21A,Table21B, 4) )
...
\clearpage
```{r echo=FALSE, results="asis"}
cat( Panel(Table22A,Table22B, 5),"\n", file = 'Tables/Appendix B/Table22.tex')
cat( Panel(Table22A,Table22B, 5) )
...
\clearpage
```{r echo=FALSE, results="asis"}
cat( Panel(Table23A,Table23B, 4),"\n", file = 'Tables/Appendix B/Table23.tex')
cat( Panel(Table23A,Table23B, 4) )
