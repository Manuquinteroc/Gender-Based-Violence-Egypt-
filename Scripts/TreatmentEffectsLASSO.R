...
latex_font = "tiny"
twosided = FALSE # if = FALSE: Perform one-sided tests (one-sided test only when hypothesize and different than 0)
negative = FALSE # Auxiliary Boolean to construct the p-values from one-sided tests
label = "fs_tv"
