...
control_means <- round(colMeans(dep_vars[which(merged$control_10018 == 1),-1]), digits = 3)
...
controls <- c("tv_evening_num", "tv_sattelite_num", "tv_top3_chan_num", 
...
omit_var <- c("Constant", "block_ids", controls, "FS_TV_zscore_base")
...
latex_font = "tiny"
twosided = FALSE # if = FALSE: Perform one-sided tests
negative = FALSE # Auxiliary boolean to construct the pvalues from one-sided tests

# Construct table
source('Scripts/TreatmentEffectJointAlgorithm.R')

# Save Table
cat(Panel_3(tableA, tableB, tableC, "\\\\shortstack\\{Index", size, 2.5), file = 'Tables/S15.tex')
...
omit_var <- c("Constant", "block_ids", controls, "FS_FW_zscore_base")
...
# Save Table
cat(Panel_3(tableA, tableB, tableC, "\\\\shortstack\\{Index", size, 1.5), file = 'Tables/S16.tex')
...
controls <- c("know_online_valid_noaut_num", "bc19_look_online_num", "dc19_look_online_num",
...
omit_var <- c("Constant", "block_ids", controls, "RF_knowledge2_zscore_base")
...
# Save Table
cat(Panel_3(tableA, tableB, tableC, "\\\\shortstack\\{Index", size), file = 'Tables/S17.tex')
...
omit_var <- c("Constant", "block_ids", controls, "RF_att1_zscore_base")

title <- "Treatment effects on attitudes towards gender and marital equality"

# Create tables and save results
size = length(dep_vars_names) + 1
cm = 18.5 # length in cm of the note for the table
latex_font = "tiny"
twosided = FALSE
negative = FALSE 
...
# Save Table
cat(Panel_3(tableA, tableB, tableC, "\\\\shortstack\\{Index", size, 1), file = 'Tables/S18.tex')
...
# Save Table
cat(Panel_3(tableA, tableB, tableC, "\\\\shortstack\\{Index", size), file = 'Tables/S19.tex')
...
# Save Table
cat(Panel_3(tableA, tableB, tableC, "\\\\shortstack\\{Index", size), file = 'Tables/S20.tex')
...
omit_var <- c("Constant", "block_ids", controls, "RF_hypDM2_zscore_base")
...
# Save Table
cat(Panel_3(tableA, tableB, tableC, "\\\\shortstack\\{Index", size), file = 'Tables/S21.tex')
...
# Save Table
cat(Panel_3(tableA, tableB, tableC, "\\\\shortstack\\{Index", size), file = 'Tables/S22.tex')
...
controls <- c("know_online_valid_noaut_num", "bc19_look_online_num", "dc19_look_online_num", "bc19_look_org_num", 
...
omit_var <- c("Constant", "block_ids", controls, unlist(refuse), "RF_dcovid2_zscore_base")
...
# Save Table
cat(Panel_3(tableA, tableB, tableC, "\\\\shortstack\\{Index", size), file = 'Tables/S23.tex')
...
omit_var <- c("Constant", "block_ids", controls, "RF_fo_zscore_base")
...
# Save Table
cat(Panel_3(tableA, tableB, tableC, "\\\\shortstack\\{Index", size), file = 'Tables/S24.tex')
...
controls <- c("bc19_yell_num", "dc19_yell_num", "bc19_hit_num", "dc19_hit_num" , 
              "age", "educ_aboveBA", "married")
...
omit_var <- c("Constant", "block_ids", controls, unlist(refuse), "RF_dcovid_zscore_base")
...
# Save Table
cat(Panel_3(tableA, tableB, tableC, "\\\\shortstack\\{Index", size), file = 'Tables/S25.tex')
...
omit_var <- c("Constant", "block_ids", controls, unlist(refuse), "RT_bcovid_zscore_base")
...
# Save Table
cat(Panel_3(tableA, tableB, tableC, "\\\\shortstack\\{Index", size), file = 'Tables/S26.tex')
...
controls <- c("talk_husband_num", "talk_family_num", 
...
omit_var <- c("Constant", "block_ids", controls, "RF_hypDM1_zscore_base")
...
# Save Table
cat(Panel_3(tableA, tableB, tableC, "\\\\shortstack\\{Index", size), file = 'Tables/S27.tex')
...
# Save Table
cat(Panel_3(tableA, tableB, tableC, "\\\\shortstack\\{Index", size), file = 'Tables/S28.tex')
...
omit_var <- c("Constant", "block_ids", controls, unlist(refuse), "RT_bcovidAccess_zscore_base")
...
# Save Table
cat(Panel_3(tableA, tableB, tableC, "\\\\shortstack\\{Index", size), file = 'Tables/S29.tex')
